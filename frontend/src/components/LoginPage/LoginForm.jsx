    ...
    <div className='rounded overflow-hidden shadow-lg bg-white h-[25rem] w-[20rem]'>
      <div className='px-3 py-4 flex flex-col justify-center items-center'>
        ...
        <form onSubmit={handleLogin}>
          ...
          <button className='bg-blue-950 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' type="submit">Login</button>
          <div className='flex items-center justify-between mt-[1rem]'>
            <p className='block text-gray-800 text-sm font-bold '>
              New to the app? <Link to="/SignUp" className="text-blue-950 hover:text-blue-700" >Sign Up</Link>
            </p>
          </div>
        </form>
      </div>
