...
const DisplayEventInfo = (event) => {
    ...
    return(
        <div className="rounded overflow-hidden shadow-lg bg-white h-[37rem] w-[50rem]">
            {eventDisplay && <div className="flex">
                <img className="h-[37rem] w-[25rem]" src={eventDisplay.image} id="image" onError={e => {e.target.src = "https://www.shutterstock.com/image-vector/default-ui-image-placeholder-wireframes-600nw-1037719192.jpg"}} />
                <div className="items-center justify-center m-[1rem] mb-[0rem]">
                    <div className="inline m-[1rem]">
                        ...
                        {Logged && <div>
                            <button className='bg-blue-700 hover:bg-blue-950 text-white font-bold py-2 px-4 rounded' onClick={handleRegister}>Register</button>
                        </div>}
                    </div>
